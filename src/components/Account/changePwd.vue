<template>
	<el-dialog ref="dialog" :visible="showChange" custom-class="w-400 h-300" title="Change password">
		<div class="ovf-auto">
      ...
      submit() {
        this.$refs.form.validate((pass) => {
          if (pass) {
            ...
            this.apiPost('account/account.php?action=change', this.form).then((res) => {
